...
namespace BestHTTP.WebSocket
{
    ...
    public sealed class WebSocket
    {
...

        {
            ...
            InternalRequest.SetHeader("Sec-WebSocket-Key",
                GetSecKey(new object[] { this, InternalRequest, uri, new object() }));
        ...
        {
            InternalRequest.SetHeader(key,value);
        }
        ...
        public void Open()
        {
            ...
            {
                ImplementationId =
 WS_Create(this.Uri.OriginalString, this.Protocol, OnOpenCallback, OnTextCallback, OnBinaryCallback, OnErrorCallback, OnCloseCallback);
